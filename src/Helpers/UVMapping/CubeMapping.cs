...
public static class CubeMapping
{
    ...
    /// </summary>
    public static void Apply(Mesh mesh, UVMapping mapping)
    {
    ...
    public static void Apply(string meshNamePath, UVMapping mapping)
    {
    ...
    public static void Apply(SubMesh subMesh, UVMapping mapping)
    {
        ...
        Vector3 maximum)
    {
        for (int index = 0; index < subMesh.Vertices.Length; index++)
        {
            ...
            Vector3 normalizedPosition = mapping.Normalize(vertex.Position, minimum, maximum);
